...
#Data: 2023-12-12
#Autores: Marcos Cardoso, Erli dos Santos, Taciara Horst
...
input_data_path <- "/cloud/project"

#Define o caminho para salvar os modelos ajustados
output_models_path <- "C:/Users/marco/OneDrive/Área de Trabalho/tuned-models_C1_v1_0_0/"

#Define o caminho para salvar os resultados
output_models_results_path <- "C:/Users/marco/OneDrive/Área de Trabalho/cross-validation-results_C1_v1_0_0/"
...
## Definição das métricas usadas (script "statiscal_functions.R) -----------------------------------------------------

source("/cloud/project/my_statistical_functions.R") # Fonte de um script externo contendo funções estatísticas
